...
//Fullscreen.include({
    /**
     * Extend the _renderSlide method so that slides of category "subsection"
...
//        if (this.get('slide').category === "subsection"){
//            $content.html(QWeb.render('website.slides.fullscreen.subsection',{widget: this}));
//        }
